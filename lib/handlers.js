            ...
            if(!err && userData){
                ...
                if(hashedPassword == userData.hashedPassword){
                    ...
                    _data.create('tokens', tokenId, tokenObject, (err) => {
                        ...
                        _performance.measure('Beginnig to end', 'entered function', 'storing token complete');
                        ...
                        _performance.measure('Token data creation', 'creating data for token', 'beginning storing data');
                        ...
                        const obs = new PerformanceObserver((list, observer) => {
                            ...
                            measurements.forEach(measurement => {
                                debug('\xb1[33m%s\xb1[0m', measurement.name + " " + measurement.duration);
                            });
                            observer.disconnect();
                        });
                ...
                _data.read('users', userPhone, (err, userData) => {
                    if(!err && userData){
                        ...
                        if(userChecks.length < config.maxChecks){
                            ...
                            const hostName = typeof parsedUrl.hostname == 'string' && parsedUrl.hostname.length > 0 ? parsedUrl.hostname : null;
